...
C {mux821_3v256x8m81.sym} 60 110 0 0 {name=x1}
C {sa_3v256x8m81.sym} 370 410 0 0 {name=x2}
C {din_3v256x8m81.sym} 0 500 0 0 {name=x3}
...
C {outbuf_oe_3v256x8m81.sym} 480 650 0 0 {name=x4}
...
C {sacntl_2_3v256x8m81.sym} 0 680 0 0 {name=x5}
...
C {wen_wm1_3v256x8m81.sym} -10 860 0 0 {name=x6}
