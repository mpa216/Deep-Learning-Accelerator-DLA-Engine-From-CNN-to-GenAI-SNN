...
S {}
E {}
T {Core 3.3V SRAM bit cell} 120 -140 0 0 0.4 0.4 {}
...
N 80 100 100 100 {lab=#net2}
N 80 0 80 100 {lab=#net2}
N 80 -0 100 -0 {lab=#net2}
N 370 0 390 0 {lab=#net1}
N 390 0 390 100 {lab=#net1}
N 370 100 390 100 {lab=#net1}
N 80 40 330 40 {lab=#net2}
N 140 50 390 50 {lab=#net1}
N 470 140 470 170 {lab=#net3}
N 0 140 -0 170 {lab=br}
N 0 110 50 110 {lab=vss}
N 50 110 50 160 {lab=vss}
N 50 160 140 160 {lab=vss}
N 420 110 470 110 {lab=vss}
N 330 160 420 160 {lab=vss}
N 390 50 470 50 {lab=#net1}
N 0 40 80 40 {lab=#net2}
N 0 40 0 80 {lab=#net2}
N -80 110 -40 110 {lab=wr}
N 510 110 540 110 {lab=wr}
N 110 -60 140 -60 {lab=vdd}
N 230 160 230 190 {lab=vss}
N -20 170 -0 170 {lab=br}
N 470 170 490 170 {lab=#net3}
N 420 110 420 160 {lab=vss}
N 470 50 470 80 {lab=#net1}
...
C {iopin.sym} 110 -60 0 1 {name=p1 lab=vdd}
...
C {iopin.sym} 490 170 0 0 {name=p7 lab=bl}
C {iopin.sym} -20 170 0 1 {name=p8 lab=br}
