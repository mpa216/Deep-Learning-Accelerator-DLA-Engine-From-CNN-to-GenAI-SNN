...
C {Cell_array32x1_3v256x8m81.sym} -50 80 0 0 {name=x1}
C {Cell_array32x1_3v256x8m81.sym} 270 80 0 0 {name=x2}
...
C {x018SRAM_cell1_3v256x8m81.sym} 680 -150 0 0 {name=x3[32:0]}
...
C {x018SRAM_cell1_dummy_R_3v256x8m81.sym} 1030 50 0 0 {name=x4[30:0]}
...
C {x018SRAM_cell1_dummy_R_3v256x8m81.sym} 1030 -240 0 0 {name=x6[2:0]}
C {ipin.sym} -140 430 0 0 {name=p30 lab=wrdr}
C {lab_pin.sym} -70 430 0 1 {name=p31 sig_type=std_logic lab=wrdr}
C {x018SRAM_cell1_3v256x8m81.sym} 700 210 0 0 {name=x5}
