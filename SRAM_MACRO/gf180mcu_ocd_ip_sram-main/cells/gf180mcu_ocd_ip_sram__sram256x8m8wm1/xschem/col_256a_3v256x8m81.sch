...
C {Cell_array8x8_3v256x8m81.sym} 200 0 0 0 {name=x1}
C {ipin.sym} 10 0 0 0 {name=p1 lab=WL[31:0]}
C {iopin.sym} 10 -120 0 1 {name=p2 lab=vdd}
C {iopin.sym} 10 -100 0 1 {name=p3 lab=vss}
C {ipin.sym} -60 70 0 0 {name=p4 lab=WEN[3:0]}
C {saout_m2_3v256x8m81.sym} 140 390 0 0 {name=x2}
C {lab_pin.sym} -10 70 0 1 {name=p5 sig_type=std_logic lab=WEN[3:0]}
C {saout_m2_3v256x8m81.sym} 1070 390 0 0 {name=x4}
...
C {saout_m2_3v256x8m81.sym} 1530 390 0 0 {name=x3}
C {saout_m2_3v256x8m81.sym} 600 390 0 0 {name=x5}
