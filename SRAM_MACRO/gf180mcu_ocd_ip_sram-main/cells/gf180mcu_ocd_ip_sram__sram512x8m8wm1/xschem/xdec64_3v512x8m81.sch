...
N 370 -130 410 -130 {lab=LWL[63:0]}
N 370 -110 410 -110 {lab=RWL[63:0]}
C {xdec32_3v512x8m81.sym} 30 -20 0 0 {name=x1}
C {ipin.sym} -220 -50 0 0 {name=p1 lab=xa[7:0]}
C {ipin.sym} -220 -30 0 0 {name=p2 lab=xb[3:0]}
C {ipin.sym} -230 30 0 0 {name=p7 lab=men}
C {opin.sym} 410 -110 0 0 {name=p8 lab=RWL[63:0]}
C {opin.sym} 410 -130 0 0 {name=p9 lab=LWL[63:0]}
C {opin.sym} 230 -230 0 0 {name=p12 lab=DLWL}
C {opin.sym} 230 -210 0 0 {name=p13 lab=DRWL}
C {pmoscap_R270_3v512x8m81.sym} 460 160 0 0 {name=x2[64:0]}
...
C {ddec_3v512x8m81.sym} 30 -220 0 0 {name=x2}
...
C {xdec32_3v512x8m81.sym} 10 180 0 0 {name=x3}
C {ipin.sym} -270 70 0 0 {name=p6 lab=xc[1:0]}
C {lab_pin.sym} -50 70 0 0 {name=p22 sig_type=std_logic lab=vss}
C {lab_pin.sym} -50 90 0 0 {name=p23 sig_type=std_logic lab=vdd}
C {lab_pin.sym} -230 70 0 1 {name=p24 sig_type=std_logic lab=xc[1:0]}
...
C {lab_pin.sym} 370 -130 0 0 {name=p26 sig_type=std_logic lab=LWL[63:0]}
C {lab_pin.sym} 370 -110 0 0 {name=p27 sig_type=std_logic lab=RWL[63:0]}
